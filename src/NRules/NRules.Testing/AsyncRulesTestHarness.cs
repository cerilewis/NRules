...
/// <summary>
/// Rules under test compiled into an async rules engine session along with the means to verify rules firing.
/// </summary>
public class AsyncRulesTestHarness
{
    private readonly RuleInvocationRecorder _invocationRecorder;
    private readonly RulesUnderTest _ruleSet;

    /// <summary>
    /// Initializes a new instance of the <see cref="AsyncRulesTestHarness"/> class.
    /// </summary>
    /// <param name="setup">Rules test setup information.</param>
    public AsyncRulesTestHarness(IRulesTestSetup setup)
    {
        ...
        var factory = compiler.CompileAsync(ruleDefinitions);
