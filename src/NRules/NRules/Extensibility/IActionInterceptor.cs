...
/// An instance of <c>IActionInterceptor</c> can be assigned to <see cref="ISessionFactoryBase.ActionInterceptor"/> or
/// <see cref="ISessionBase.ActionInterceptor"/>, so that invocation of all rule actions is delegated to the interceptor.
