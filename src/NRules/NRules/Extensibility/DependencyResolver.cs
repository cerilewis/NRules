...
/// An instance of <c>IDependencyResolver</c> can be assigned to <see cref="ISessionFactoryBase.DependencyResolver"/> or
/// <see cref="ISessionBase.DependencyResolver"/>, so that all requests for rule dependencies resolution are fulfilled by that resolver.
/// </summary>
